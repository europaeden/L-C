...
namespace Compiler.SyntacticAnalysis
{
    ...
    public class Parser
    {
        ...
        private ICommandNode ParseWhileCommand()
        {
            ...
            IExpressionNode expression = ParseExpression();
            Accept(Do);
            ICommandNode DoCommand = ParseCommand();
            Accept(After);
            ICommandNode AfterCommand = ParseSingleCommand();
            Accept(Wend);
            return new WhileCommandNode(expression, DoCommand, AfterCommand, startPosition);
        }
        ...
        private IExpressionNode ParseCallExpression()
        {
            ...
            IdentifierNode Identifier = ParseIdentifier();
            Accept(LeftSqaureBracket);
            IParameterNode parameter = ParseParameter();
            Accept(RightSqaureBracket);
        ...
        private IExpressionNode ParseBinaryExpression()
        {
            ...
            return new BinaryExpressionNode(leftExpression, operatorNode, rightExpression);
        }
       ...
       private IParameterNode ParseValueParameter()
        {
            ...
            return new ValueParameterNode(position);
        }
