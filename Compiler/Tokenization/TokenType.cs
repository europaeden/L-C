...
namespace Compiler.Tokenization
{
    ...
    public enum TokenType
    {
        ...
        Begin, Const, Do, Else, End, If, In, Let, Then, Var, While, Declare, Global, Endif, After, Wend, Endlet, Dec, As, Void,

        // punctuation - terminals (Becomes is for assignment (:=) , Is is for constants (~))
        Colon, Semicolon, Becomes, Is, LeftBracket, RightBracket, LeftSqaureBracket, RightSqaureBracket,
