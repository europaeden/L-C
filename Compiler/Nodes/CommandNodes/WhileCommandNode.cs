namespace Compiler.Nodes
{
    ...
    public class WhileCommandNode : ICommandNode
    {
        ...
        /// The command inside the loop
        /// </summary>
        public ICommandNode AfterCommand { get; }
        /// <summary>
        ...
        public WhileCommandNode(IExpressionNode expression, ICommandNode doCommand, ICommandNode afterCommand, Position position)
        {
